...
namespace DrawingApp
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            this.Suspending += SetOnSuspending;
        }
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                // 建立框架做為巡覽內容，並巡覽至第一頁
                rootFrame = new Frame();
                rootFrame.NavigationFailed += SetOnNavigationFailed;
        ...
        void SetOnNavigationFailed(object sender, NavigationFailedEventArgs e)
        {
            const string TEXT = "Failed to load Page ";
            throw new Exception(TEXT + e.SourcePageType.FullName);
        }
        ...
        private void SetOnSuspending(object sender, SuspendingEventArgs e)
        {
